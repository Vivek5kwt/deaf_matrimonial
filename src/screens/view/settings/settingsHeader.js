...
const SettingHeader = ({ navigation, profileCounts }) => {
  const tabs = ['Photo Privacy', 'Contact View', 'Change Password','Block List'];
  ...
  useEffect(() => {
    const routeToTabMap = {
      Screen52: 'Photo Privacy',
      Screen53: 'Contact View',
      Screen54: 'Change Password',
      Screen56: 'Block List',
    };
  ...
  const handleTabPress = (tab, index) => {
    ...
    const tabToRouteMap = {
      'Photo Privacy': 'Screen52',
      'Contact View': 'Screen53',
      'Change Password': 'Screen54',
      'Block List': 'Screen56',
    };
